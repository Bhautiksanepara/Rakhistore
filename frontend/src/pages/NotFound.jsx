...
export default function NotFound() {
  return (
    <div className="mx-auto flex max-w-6xl flex-col items-center px-6 py-24 text-center">
      <p className="font-heading text-6xl text-saffron">404</p>
      ...
      <Link
        to="/"
        className="mt-6 rounded-full bg-saffron px-6 py-2 text-sm font-medium text-white transition hover:bg-saffron-light"
      >
        Back to Home
      </Link>
    </div>
